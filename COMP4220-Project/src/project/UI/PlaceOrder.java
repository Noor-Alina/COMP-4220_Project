...
public class PlaceOrder extends JFrame {
	...
	public PlaceOrder(int id, String name) {
		this.emp_id = id;
		this.emp_fname = name;
		...
		placeOrderBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String result = bm.placeSpecificOrder(Long.parseLong(studIdTxtField.getText()), Long.parseLong(isbnTxtField.getText()), emp_id, emailTxtField.getText());			
